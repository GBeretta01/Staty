...
menu_ATr:	if(AT>0){
		...
		case 5:
			system("CLS");
			cout<<"\tVersion"<<endl;
			cout<<"Versión Alpha 1a1.1"<<endl;
			cout<<"\nCambios:"<<endl;
			cout<<"1. Se solucionó el error al compilar\n2. Se arregló el error que daban los cases del switch()\n3. Se arregló el error del case 2 duplicado"<<endl;
